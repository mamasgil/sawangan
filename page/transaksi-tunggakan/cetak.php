...
<html>
    ...
    <body onload="window.print()">
        ...
        <div class="tes">
			<div id="watermark">
				<img src="'. $base_url . 'assets/logo2.png" height="100%" width="100%">
			</div>
			...
			<div class="bagiansetengah">
				<img src="'. $base_url . 'assets/logo2.png" height="50" width="50" align="right">
			</div>
			...
			<div class="bagiansetengah">
				<table style="width:100%; ">
					...
					<tr>
						<td>rumah</td><td>: '.$rumah." - ". $r['nama_rumah'] .'</td>
					</tr>
				</table>
			</div>
			<div class="bagiansetengah" >
